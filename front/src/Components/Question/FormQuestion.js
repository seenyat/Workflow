  ...
  return (
    <>
      {!formStatus ? (
        ...
        <form
          className=" bg-white shadow-md rounded-md flex flex-col mx-auto my-2 mb-24 p-6 w-full md:max-w-4xl "
          onSubmit={postNewQuestion}
        >
          <label className="mt-1 w-full text-center text-2xl block font-medium text-gray-700">
          ...
          <div className="mt-1">
            <input
              ...
              name="questionTitle"
              id="questionTitle"
              className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-1/2 sm:text-sm border border-gray-300 rounded-md mt-2 mb-4 p-3 "
